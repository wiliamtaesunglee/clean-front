...
import { RequiredFieldValidation, EmailValidation, MinLeghtValidation } from '~/validation/validators'
...
export class ValidationBuilder {
  ...
  min (length: number): ValidationBuilder {
    this.validations.push(new MinLeghtValidation(this.fieldName, length))
    return this
  }
